...
## Universe layout (decided 2026-09-17)
**Three saves, one per level**, matching the Stabbyverse: `HU_Prep`, `HU_College`, `HU_Pro`. Each has its own
...
|---|---|---|---|---|---|---|---|
| Hoops Universe Prep (HUP) | HU_Prep | 16 | 15 | 12/team = 192 | 3/team = **48** | 14-17 | 30 |
| Hoops Universe College (HUC) | HU_College | 16 | 15 | 12/team = 192 | 3/team = **48** | 18-21 | 32 |
| Hoops Universe Pro (HUX) | HU_Pro | 20 | 15 | 12/team = 240 | 3/team = **60** | 22-34 | 58 |
...
early-NBA divisional format); no Hoops Universe league uses it. `config._check_bracket()` enforces all of this,
